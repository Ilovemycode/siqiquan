...
/* http respose 结果*/
#define XIYI_GETJSONFROMRESPONSE [NSJSONSerialization JSONObjectWithData:responseObject options:NSJSONReadingMutableContainers error:nil]
...
-(void)landClick
{
    ...
    NSString *regietUrl = [NSString stringWithFormat:@"http://api.thinkwit.com/api/Account/Register"];
    NSDictionary *postDict = @{@"PhoneNum":self.userPhone,@"Password":passward.text,@"ConfirmPassword":passward.text};
    
    [AFNetworking_RequestData requestMethodPOSTUrl:regietUrl dic:postDict Succed:^(id responseObject) {
