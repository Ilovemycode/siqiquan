...
- (void)setupViews{
  ...
  for (int i = 0; i<self.titleArray.count; i++) {
    ...
    [button setTitleColor:HEXRGBCOLOR(0x8e8e93) forState:UIControlStateNormal];
    ...
    if (i == 0) {
      ...
      [button setTitleColor:HEXRGBCOLOR(0xff9600) forState:UIControlStateNormal];
      [self buttonWithMovingLien:button andHide:NO];
      _selectedButton = button;
      
      [button mas_makeConstraints:^(MASConstraintMaker *make) {
        
//        make.width.mas_equalTo(button.width + 44);
          make.width.mas_equalTo(XMGScreenW / self.titleArray.count);
...
- (void)didClickButton:(UIButton *)button{
  ...
  [_selectedButton setTitleColor:HEXRGBCOLOR(0x8e8e93) forState:UIControlStateNormal];
  [button setTitleColor:HEXRGBCOLOR(0xff9600) forState:UIControlStateNormal];
  _selectedButton = button;
...
- (void)buttonAddMovingLine:(UIButton *)button{
  ...
  movingLine.backgroundColor = HEXRGBCOLOR(0xff9600);
  movingLine.tag = 100;
